...
public class PublishDateParserTest {
    ...
    public Element prepareElement(String date) {
    ...
    public void parseXMinsAgo() throws ParseException {
        ...
        Temporal date = TpbTorrentRowParser.PublishDateParser.parse(td);
        assertEquals(LocalDateTime.now().minusMinutes(20), date);
    }
